    ...
    <header className="fixed inset-x-0 top-0 z-30 border-b border-white/10 bg-[#1a1022]/85 backdrop-blur-xl">
      <div className="mx-auto flex h-[76px] max-w-7xl items-center justify-between px-5 lg:px-8">
        <button onClick={() => window.scrollTo({ top:0, behavior:'smooth' })} className="flex items-center gap-3" data-testid="button-home">
          <div className="flex h-11 w-11 items-center justify-center rounded-full border-2 border-[#f9c72b] bg-[#772d90] text-xs font-black text-[#f9c72b]">PONT</div>
          <div className="hidden leading-none sm:block"><span className="display block text-lg font-bold tracking-tight text-[#fff7df]">Pont Açaí</span><span className="text-[10px] uppercase tracking-[.2em] text-[#f9c72b]">do seu jeito</span></div>
        </button>
      ...
      <section className="relative min-h-[680px] overflow-hidden border-b border-[#f9c72b]/20 pt-[76px]">
        ...
        <div className="relative mx-auto grid min-h-[604px] max-w-7xl items-center gap-12 px-5 py-16 lg:grid-cols-[1.1fr_.9fr] lg:px-8">
          <div className="reveal max-w-2xl">
            ...
            <h1 className="display text-[clamp(3.25rem,8vw,7.8rem)] font-bold leading-[.87] tracking-[-.075em] text-[#fff7df]">A noite<br /><span className="text-[#f9c72b]">pede Pont.</span></h1>
            <p className="mt-7 max-w-md text-lg leading-relaxed text-[#d8c8d9]">Açaí carregado, pizza de massa artesanal e lanche sem miséria. Seu ponto de encontro depois das 18h.</p>
            ...
            <div className="mt-12 flex gap-8 border-t border-white/10 pt-6"><div><span className="flex items-center gap-1.5 text-[#f9c72b]"><Star size={15} fill="currentColor" /> <b className="text-lg">4,9</b></span><span className="text-xs text-[#a997ad]">avaliação no cardápio</span></div><div><span className="display block text-lg font-bold text-[#fff7df]">R$ 10,00</span><span className="text-xs text-[#a997ad]">pedido mínimo</span></div><div><span className="display block text-lg font-bold text-[#fff7df]">23:00</span><span className="text-xs text-[#a997ad]">fecha hoje</span></div></div>
          </div>
